...
const SHELL_VERSION = 'snb-app-shell-v492';
const AUDIO_CACHE = 'snb-audio-v1';

const SHELL = [
  './', './index.html', './app.css?v=210', './app.js?v=298', './icons.js?v=2', './current.js?v=19',
  './config.js?v=9', './store.js?v=89', './from-justin.js?v=21', './player.html',
