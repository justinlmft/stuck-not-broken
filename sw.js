...
const SHELL_VERSION = 'snb-app-shell-v442';
const AUDIO_CACHE = 'snb-audio-v1';

const SHELL = [
  './', './index.html', './app.css?v=192', './app.js?v=252', './icons.js', './current.js?v=14',
  './config.js?v=8', './store.js?v=81', './from-justin.js?v=16', './player.html',
