...
const SHELL_VERSION = 'snb-app-shell-v410';
const AUDIO_CACHE = 'snb-audio-v1';

const SHELL = [
  './', './index.html', './app.css?v=186', './app.js?v=237', './icons.js', './current.js?v=8',
  './config.js?v=6', './store.js?v=73', './from-justin.js?v=16', './player.html',
