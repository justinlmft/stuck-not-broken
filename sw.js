...
const SHELL_VERSION = 'snb-app-shell-v399';
const AUDIO_CACHE = 'snb-audio-v1';

const SHELL = [
  './', './index.html', './app.css?v=181', './app.js?v=230', './icons.js', './current.js?v=7',
  './config.js?v=6', './store.js?v=70', './from-justin.js?v=16', './player.html',
