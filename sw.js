...
const SHELL_VERSION = 'snb-app-shell-v421';
const AUDIO_CACHE = 'snb-audio-v1';

const SHELL = [
  './', './index.html', './app.css?v=192', './app.js?v=242', './icons.js', './current.js?v=14',
  './config.js?v=6', './store.js?v=75', './from-justin.js?v=16', './player.html',
