...
const SHELL_VERSION = 'snb-app-shell-v332';
const AUDIO_CACHE = 'snb-audio-v1';

const SHELL = [
  './', './index.html', './app.css?v=141', './app.js?v=174', './icons.js', './current.js?v=2',
  './config.js?v=4', './store.js?v=64', './from-justin.js?v=11', './player.html',
