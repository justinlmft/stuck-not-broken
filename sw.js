...
const SHELL_VERSION = 'snb-app-shell-v448';
const AUDIO_CACHE = 'snb-audio-v1';

const SHELL = [
  './', './index.html', './app.css?v=192', './app.js?v=256', './icons.js', './current.js?v=17',
  './config.js?v=8', './store.js?v=82', './from-justin.js?v=17', './player.html',
