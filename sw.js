...
const SHELL_VERSION = 'snb-app-shell-v246';
const AUDIO_CACHE = 'snb-audio-v1';

const SHELL = [
  './', './index.html', './app.css?v=79', './app.js?v=110', './icons.js', './current.js?v=2',
  './config.js?v=3', './store.js?v=59', './from-justin.js?v=11', './player.html',
