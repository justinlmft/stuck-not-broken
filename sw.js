...
const SHELL_VERSION = 'snb-app-shell-v247';
const AUDIO_CACHE = 'snb-audio-v1';

const SHELL = [
  './', './index.html', './app.css?v=80', './app.js?v=111', './icons.js', './current.js?v=2',
  './config.js?v=3', './store.js?v=60', './from-justin.js?v=11', './player.html',
