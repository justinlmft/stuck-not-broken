...
const SHELL_VERSION = 'snb-app-shell-v491';
const AUDIO_CACHE = 'snb-audio-v1';

const SHELL = [
  './', './index.html', './app.css?v=210', './app.js?v=297', './icons.js?v=2', './current.js?v=19',
  './config.js?v=9', './store.js?v=87.1', './from-justin.js?v=20', './player.html',
