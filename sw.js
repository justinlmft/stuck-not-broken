...
const SHELL_VERSION = 'snb-app-shell-v507';
const AUDIO_CACHE = 'snb-audio-v1';

const SHELL = [
  './', './index.html', './app.css?v=214', './app.js?v=312', './icons.js?v=2', './current.js?v=19',
  './config.js?v=9', './store.js?v=98', './from-justin.js?v=22', './player.html', './practice-engine.html',
