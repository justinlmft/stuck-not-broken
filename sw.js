...
const SHELL_VERSION = 'snb-app-shell-v405';
const AUDIO_CACHE = 'snb-audio-v1';

const SHELL = [
  './', './index.html', './app.css?v=184', './app.js?v=234', './icons.js', './current.js?v=7',
  './config.js?v=6', './store.js?v=71', './from-justin.js?v=16', './player.html',
