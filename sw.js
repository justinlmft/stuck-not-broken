...
const SHELL_VERSION = 'snb-app-shell-v281';
const AUDIO_CACHE = 'snb-audio-v1';

const SHELL = [
  './', './index.html', './app.css?v=96', './app.js?v=128', './icons.js', './current.js?v=2',
  './config.js?v=3', './store.js?v=61', './from-justin.js?v=11', './player.html',
