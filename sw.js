...
const SHELL_VERSION = 'snb-app-shell-v342';
const AUDIO_CACHE = 'snb-audio-v1';

const SHELL = [
  './', './index.html', './app.css?v=149', './app.js?v=183', './icons.js', './current.js?v=3',
  './config.js?v=4', './store.js?v=64', './from-justin.js?v=12', './player.html',
