...
const SHELL_VERSION = 'snb-app-shell-v216';
const AUDIO_CACHE = 'snb-audio-v1';

const SHELL = [
  './', './index.html', './app.css?v=70', './app.js?v=94', './icons.js', './current.js',
  './config.js?v=2', './store.js?v=53', './from-justin.js?v=11', './player.html',
