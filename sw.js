...
const SHELL_VERSION = 'snb-app-shell-v390';
const AUDIO_CACHE = 'snb-audio-v1';

const SHELL = [
  './', './index.html', './app.css?v=177', './app.js?v=222', './icons.js', './current.js?v=7',
  './config.js?v=4', './store.js?v=69', './from-justin.js?v=16', './player.html',
