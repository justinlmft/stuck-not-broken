...
const SHELL_VERSION = 'snb-app-shell-v392';
const AUDIO_CACHE = 'snb-audio-v1';

const SHELL = [
  './', './index.html', './app.css?v=178', './app.js?v=224', './icons.js', './current.js?v=7',
  './config.js?v=6', './store.js?v=69', './from-justin.js?v=16', './player.html',
