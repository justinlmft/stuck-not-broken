...
const SHELL_VERSION = 'snb-app-shell-v374';
const AUDIO_CACHE = 'snb-audio-v1';

const SHELL = [
  './', './index.html', './app.css?v=166', './app.js?v=207', './icons.js', './current.js?v=7',
  './config.js?v=4', './store.js?v=69', './from-justin.js?v=15', './player.html',
