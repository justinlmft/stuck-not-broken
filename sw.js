...
const SHELL_VERSION = 'snb-app-shell-v240';
const AUDIO_CACHE = 'snb-audio-v1';

const SHELL = [
  './', './index.html', './app.css?v=77', './app.js?v=105', './icons.js', './current.js?v=2',
  './config.js?v=3', './store.js?v=55', './from-justin.js?v=11', './player.html',
