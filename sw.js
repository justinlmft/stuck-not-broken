...
const SHELL_VERSION = 'snb-app-shell-v500';
const AUDIO_CACHE = 'snb-audio-v1';

const SHELL = [
  './', './index.html', './app.css?v=210', './app.js?v=306', './icons.js?v=2', './current.js?v=19',
  './config.js?v=9', './store.js?v=93', './from-justin.js?v=22', './player.html', './practice-engine.html',
