...
const SHELL_VERSION = 'snb-app-shell-v419';
const AUDIO_CACHE = 'snb-audio-v1';

const SHELL = [
  './', './index.html', './app.css?v=191', './app.js?v=241', './icons.js', './current.js?v=13',
  './config.js?v=6', './store.js?v=74', './from-justin.js?v=16', './player.html',
