...
const SHELL_VERSION = 'snb-app-shell-v284';
const AUDIO_CACHE = 'snb-audio-v1';

const SHELL = [
  './', './index.html', './app.css?v=102', './app.js?v=135', './icons.js', './current.js?v=2',
  './config.js?v=4', './store.js?v=63', './from-justin.js?v=11', './player.html',
