...
const SHELL_VERSION = 'snb-app-shell-v241';
const AUDIO_CACHE = 'snb-audio-v1';

const SHELL = [
  './', './index.html', './app.css?v=78', './app.js?v=106', './icons.js', './current.js?v=2',
  './config.js?v=3', './store.js?v=56', './from-justin.js?v=11', './player.html',
