...
const SHELL_VERSION = 'snb-app-shell-v429';
const AUDIO_CACHE = 'snb-audio-v1';

const SHELL = [
  './', './index.html', './app.css?v=192', './app.js?v=245', './icons.js', './current.js?v=14',
  './config.js?v=7', './store.js?v=77', './from-justin.js?v=16', './player.html',
