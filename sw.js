...
const SHELL_VERSION = 'snb-app-shell-v353';
const AUDIO_CACHE = 'snb-audio-v1';

const SHELL = [
  './', './index.html', './app.css?v=152', './app.js?v=190', './icons.js', './current.js?v=5',
  './config.js?v=4', './store.js?v=68', './from-justin.js?v=12', './player.html',
