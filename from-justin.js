...
(function (global) {
  ...
  DEEP.overlays.watchFor.play = [
    "If the pace keeps climbing and the safety mixed into it doesn't keep up, this same energy can tip into flight/fight: wired and edgy instead of driven. Irritability creeping into what started as motivation is the tell.",
  ...
  DEEP.overlays.watchFor.stillness = [
    "The same quiet that restores you in stillness can tip into shutdown if the safety mixed into it thins out. The tell is whether it still feels restful, or is starting to feel flat and far away instead.",
