...
(function (global) {
  ...
  const BLOG_STAGE = {
    ...
    movement_building: {
      direction: {
        rising: ["Your safety reads a bit higher lately than when you started checking in. Early, but a good direction. Worth leaning into where you can."],
        falling: ["Your safety reads a little lower lately. Safety comes and goes, and a dip is the 'goes' part. Be a little gentler with yourself over the next few days."],
